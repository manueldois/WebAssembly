(module
 ...
 (func $Sort Colors Benchmark/src/assembly/index/getPixelRGB (; 26 ;) (type $FUNCSIG$iiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  local.get $1
  local.get $2
  i32.mul
  local.get $0
 ...
 (func $Sort Colors Benchmark/src/assembly/index/setPixelRGB (; 27 ;) (type $FUNCSIG$viiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32)
  local.get $1
  local.get $2
  i32.mul
  local.get $0
 ...
 (func $Sort Colors Benchmark/src/assembly/index/rgbToHsl (; 28 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 f32)
  (local $2 f32)
  (local $3 f32)
  (local $4 f32)
 ...
 (func $Sort Colors Benchmark/src/assembly/index/sortImgData (; 29 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
